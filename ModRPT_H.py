...
# Define fluid cases dictionary
cases = {
    'FRMB': {'rho_f': 1.09, 'k_f': 2.8},    # Brine case
    'FRMO': {'rho_f': 0.78, 'k_f': 0.94},   # Oil case
    'FRMG': {'rho_f': 0.25, 'k_f': 0.06},   # Gas case
    'FRMMIX': {'rho_f': None, 'k_f': None}  # Mixed case (calculated later)
}
