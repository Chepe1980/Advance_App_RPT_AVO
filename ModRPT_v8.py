...
def create_interactive_crossplot(logs):
    ...
    try:
        ...
        # Create combined LFC column that shows different fluid types
        ...
        if 'LFC' not in logs.columns:
            ...
            if 'LFC_B' in logs.columns:
                ...
                # Approximate classification based on IP and Vp/Vs ranges
...
if uploaded_file is not None:
    try:
        ...
        if model_choice not in ["Soft Sand RPT (rockphypy)", "Stiff Sand RPT (rockphypy)"]:
            ...
            # Vp/Vs for different fluid cases
        ...
        # Interactive Crossplot (showing all fluid cases)
        ...
        # Original 2D crossplots (including mixed case)
        ...
        # AVO Modeling and subsequent sections remain the same as in original code...
        # (Keeping the rest of the code unchanged for brevity, as the fixes focus on the crossplot issue)
        
        # Continue with AVO Modeling, Time-Frequency Analysis, etc.
        # [The rest of the AVO modeling, wedge modeling, etc. code remains the same]
        
        # For completeness, here's the start of the remaining sections:
        if model_choice not in ["Soft Sand RPT (rockphypy)", "Stiff Sand RPT (rockphypy)"]:
            ...
            for case in cases:
                # Skip oil if column doesn't exist
            ...
            # The remaining sections (Time-Frequency Analysis, Synthetic Gathers, 
            # Wedge Modeling, etc.) would continue here...
